...
export class ProductpageComponent implements OnInit {
  ...
  UserId:any;
  constructor(private productpageService:ProductpageService,private cartService : CartService,private router:Router,userService:UserService  ) { }
